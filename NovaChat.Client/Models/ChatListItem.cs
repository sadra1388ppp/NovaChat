...
public sealed class ChatListItem : INotifyPropertyChanged
{
    ...
    {
        get => _isOnline;
        set { if (_isOnline == value) return; _isOnline = value; OnPropertyChanged(); OnPropertyChanged(nameof(OnlineVisibility)); OnPropertyChanged(nameof(ProfileStatusText)); }
    }

    public int UnreadCount
    {
        get => _unreadCount;
        set { if (_unreadCount == value) return; _unreadCount = Math.Max(0, value); OnPropertyChanged(); OnPropertyChanged(nameof(UnreadVisibility)); OnPropertyChanged(nameof(UnreadText)); }
    }
    ...
    {
        get => _avatarUri;
        set { if (string.Equals(_avatarUri, value, StringComparison.Ordinal)) return; _avatarUri = value; OnPropertyChanged(); OnPropertyChanged(nameof(HasAvatar)); }
    }
