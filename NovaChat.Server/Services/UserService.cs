...
public class UserService
{
    ...
    public async Task<RegisterResult> RegisterAsync(RegisterDto dto)
    {
        ...
        try
        {
            ...
            // User IDs are generated by NovaChat and the existing MariaDB Users.Id
            // column is not database-generated. Insert the ID explicitly so MariaDB
            // never has to generate it and cannot reject the row for a missing value.
